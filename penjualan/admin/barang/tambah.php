 <?php 
    ...
    if(isset($_POST['submit'])){
      ...
      $lokasi = '../../assets/img/barang/'.$nama_gambar;
      move_uploaded_file($_FILES['gambar']['tmp_name'], $lokasi);

      $sql = "INSERT INTO barang(kode_barang, nama_barang, harga, stok, gambar) VALUES('$kode_barang', '$nama_barang', '$harga', '$stok', '$nama_gambar')";
